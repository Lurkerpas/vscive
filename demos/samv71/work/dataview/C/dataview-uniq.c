...
{
    flag ret = TRUE;
    ret = ((((*(pVal)) == PID_testfunction)) || (((*(pVal)) == PID_env)));
...
#ifdef __cplusplus
const asn1SccPID asn1SccPID_constant = PID_testfunction;
#endif
...

	{
	    ...
	    *pErrCode = ret ? 0 : ERR_UPER_DECODE_PID;
	    if (ret) {
	        ...
	        (*(pVal)) = PID_testfunction;             /*COVERAGE_IGNORE*/
	    }
	}
