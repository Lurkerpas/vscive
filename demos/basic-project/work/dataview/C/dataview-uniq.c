...
#ifdef __cplusplus
const asn1SccDataItem asn1SccDataItem_constant = 0UL;
#endif
...
void asn1SccDataItem_Initialize(asn1SccDataItem* pVal)
{
	...
	(*(pVal)) = (asn1SccDataItem)asn1SccDataItem_constant;
}
...
{
    flag ret = TRUE;
    ret = ((((((*(pVal)) == PID_receiver)) || (((*(pVal)) == PID_sender)))) || (((*(pVal)) == PID_env)));
...
#ifdef __cplusplus
const asn1SccPID asn1SccPID_constant = PID_receiver;
#endif
...

	{
	    ...
	    *pErrCode = ret ? 0 : ERR_UPER_DECODE_PID;
	    if (ret) {
	        ...
	        (*(pVal)) = PID_receiver;             /*COVERAGE_IGNORE*/
	    }
	}
