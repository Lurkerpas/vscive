...
#define ERR_DATAITEM		1  /*(0..65535)*/
flag asn1SccDataItem_IsConstraintValid(const asn1SccDataItem* pVal, int* pErrCode);

#ifdef __cplusplus
extern const asn1SccDataItem asn1SccDataItem_constant;
#else
#define asn1SccDataItem_constant 0UL
#endif

void asn1SccDataItem_Initialize(asn1SccDataItem* pVal);

#define ERR_UPER_ENCODE_DATAITEM		2  /**/
#define asn1SccDataItem_REQUIRED_BYTES_FOR_ENCODING       2
#define asn1SccDataItem_REQUIRED_BITS_FOR_ENCODING        16

flag asn1SccDataItem_Encode(const asn1SccDataItem* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_UPER_DECODE_DATAITEM		3  /**/
flag asn1SccDataItem_Decode(asn1SccDataItem* pVal, BitStream* pBitStrm, int* pErrCode);

#define asn1SccDataItem_REQUIRED_BYTES_FOR_ACN_ENCODING       2
#define asn1SccDataItem_REQUIRED_BITS_FOR_ACN_ENCODING        16

#define ERR_ACN_ENCODE_DATAITEM		4  /**/

flag asn1SccDataItem_ACN_Encode(const asn1SccDataItem* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_ACN_DECODE_DATAITEM		5  /**/
