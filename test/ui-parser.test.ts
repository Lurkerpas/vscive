...
import { serializeUiXml } from '../src/serializers/UiXmlSerializer';

test('parseUiXml prefers brace-wrapped ids when both bare and brace-wrapped entries exist', () => {
...
test('parseUiXml canonicalizes bare UUID ids to brace-wrapped ids', () => {
    const ui = parseUiXml(`<?xml version="1.0"?>
<UI version="1.0">
  <Entity id="88598203-48ac-4c5c-8c37-840233f64a7c">
    <Taste coordinates="0 0 24000 16000"/>
    ...
    assert.deepEqual(Object.keys(ui.entities), ['{88598203-48ac-4c5c-8c37-840233f64a7c}']);
});

test('serializeUiXml writes brace-wrapped UUID ids', () => {
    const xml = serializeUiXml({
        version: '1.0',
        entities: {
            '88598203-48ac-4c5c-8c37-840233f64a7c': { coordinates: [0, 0, 24000, 16000] },
        },
    });

    assert.match(xml, /<Entity id="\{88598203-48ac-4c5c-8c37-840233f64a7c\}">/u);
});